    ...
    try:
        ...
        if '/add' in msgText:
            ...
            if isadmin:
                try:
                    ...
                    jdb.save()
                    msg = '✄1�7 @'+user+' has being added to the bot!'
        ...
        if '/useradm' in msgText:
            ...
            if isadmin:
                ...
                message = bot.sendMessage(update.message.chat.id,'🦾You are bot administrator, so you have total control over itself✄1�7')
            else:
                message = bot.sendMessage(update.message.chat.id,'📄')
                message = bot.sendMessage(update.message.chat.id,'🙁You are just an user, for now you have limitated control❄1�7')
            return
        # end
        ...
        if '/xdlink' in msgText:
            ...
            try: 
                ...
                msg = f'〄1�7*El comando debe ir acompañado de un link moodle*'
                bot.sendMessage(chat_id = chatid, parse_mode = 'Markdown', text = msg)
            return
        ...
        if '/channelid' in msgText:
            ...
            try:
                ...
                msg = f'〄1�7*El comando debe ir acompañado de un id de canal*\n\n*Ejemplo: -100XXXXXXXXXX*'
                bot.sendMessage(chat_id = chatid, parse_mode = 'Markdown', text = msg)
            return
        ...
        if '/start' in msgText:
            start_msg = '╭─┄1�7┄1�7ⓘ🎐Hola @' + str(username)+'┄1�7〄\n│\n'
            start_msg+= '├🔄1�7 Enlaces soportados enlaces directos\n│\n'
            start_msg+= '├❔ Como Descargar\n│\n'
            start_msg+= '┄1�71. Envía el enlace directo.\n'
            start_msg+= '┄1�72. Usa el TXT de descarga que se\n│genera y los abres con el XDownloader\n│\n'
            start_msg+= '├👨🏻�1�7�💻Activar comandos /commands \n'
            start_msg+= '├🤖Para saber más del bot /about \n'
            start_msg+= '├👩🏻�1�7�💻Para saber los comandos es /help\n│\n'
            start_msg+= '╰ⓘQue disfutes del bot┄1�7〄\n'
            ...
            if loged:
                ...
                client.logout()
                bot.editMessageText(message,'File deleted🗑︄1�7')
            else:
                bot.editMessageText(message,'🤔')
                message = bot.sendMessage(update.message.chat.id,'⚠️Error and possible causes:\n1-Check your account\n2-Server disabled: '+client.path)
            ...
            if loged:
                ...
                client.logout()
                bot.editMessageText(message,'Files deleted🗑︄1�7')
            else:
                bot.editMessageText(message,'🤔')
                message = bot.sendMessage(update.message.chat.id,'⚠️Error and possible causes:\n1-Check your account\n2-Server disabled: '+client.path)
...
def main():
    bot_token = '5644270401:AAGqn3-Dsowufou40xfLWfLJye0yU7AT9TM'
